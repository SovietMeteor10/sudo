...
export type SyncEventSlice = "contact" | "subscription" | "message" | "draft" | "profile" | "read_state" | "conversation_settings" | "tombstone_watermark" | "message_reaction" | "message_attachment";
